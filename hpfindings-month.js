...
function pseudolistTrafficEnglish()
{
  ...
  const incomingData = "155330<SeP>32523<SeP>122807<SeP>8781";
...
function pseudolistAttacksEnglish()
{
  ...
  const column4Label = "Unique IP Addresses";
  const incomingData = "122807<SeP>69785<SeP>53022<SeP>4362";
  const tmpData      = incomingData.split(ARRAY_SEP);
  const column1Data  = tmpData[0];
  const column2Data  = tmpData[1];
  const column3Data  = tmpData[2];
...
function pseudolistAttacksSuccessfulEnglish()
{
  ...
  const column4Label = "Unique IP Addresses";
  const incomingData = "53022<SeP>7355<SeP>45667<SeP>3331";
  const tmpData      = incomingData.split(ARRAY_SEP);
  const column1Data  = tmpData[0];
  const column2Data  = tmpData[1];
  const column3Data  = tmpData[2];
...
function pseudolistMalwareInteractionsEnglish()
{
  ...
  const incomingData = "7066<SeP>6417<SeP>649";
  const tmpData      = incomingData.split(ARRAY_SEP);
  const column1Data  = tmpData[0];
  const column2Data  = tmpData[1];
  const column3Data  = tmpData[2];
...
function pseudolistMalwareFilesEnglish()
{
  ...
  const incomingData = "101<SeP>9<SeP>92<SeP>12";
  const tmpData      = incomingData.split(ARRAY_SEP);
  const column1Data  = tmpData[0];
  const column2Data  = tmpData[1];
  const column3Data  = tmpData[2];
...
function listTrafficIPsEnglish()
{
  ...
  const column1Data  = "IP01 (<span class=blur>110.39.172.238</span>)<SeP>IP02 (<span class=blur>45.82.121.247</span>)<SeP>IP03 (<span class=blur>185.7.214.180</span>)<SeP>IP04 (<span class=blur>46.8.237.53</span>)<SeP>IP05 (<span class=blur>80.94.95.112</span>)<SeP>IP06 (<span class=blur>37.44.238.88</span>)<SeP>IP07 (<span class=blur>92.255.85.35</span>)<SeP>IP08 (<span class=blur>38.12.5.41</span>)<SeP>IP09 (<span class=blur>2.57.122.193</span>)<SeP>IP10 (<span class=blur>64.23.130.251</span>)";
  const column2Data  = "AS38264<SeP>AS44486<SeP>AS207566<SeP>AS56971<SeP>AS204428<SeP>AS34534<SeP>AS207566<SeP>AS400619<SeP>AS47890<SeP>AS14061";
  const column3Data  = "<span class=\u0022fi fi-pk\u0022></span>\u00a0Pakistan<SeP><span class=\u0022fi fi-de\u0022></span>\u00a0Germany<SeP><span class=\u0022fi fi-ru\u0022></span>\u00a0Russia<SeP><span class=\u0022fi fi-fi\u0022></span>\u00a0Finland<SeP><span class=\u0022fi fi-ro\u0022></span>\u00a0Romania<SeP><span class=\u0022fi fi-fr\u0022></span>\u00a0France<SeP><span class=\u0022fi fi-hk\u0022></span>\u00a0Hong Kong<SeP><span class=\u0022fi fi-us\u0022></span>\u00a0United States<SeP><span class=\u0022fi fi-ro\u0022></span>\u00a0Romania<SeP><span class=\u0022fi fi-us\u0022></span>\u00a0United States";
  const column4Data  = "21294<SeP>6226<SeP>1224<SeP>877<SeP>863<SeP>766<SeP>651<SeP>604<SeP>570<SeP>528";
  const listLocale   = "en-US"
...
function listScansIPsEnglish()
{
  ...
  const column3Label = "Country";
  const column4Label = "Count";
  const column1Data  = "IP07 (<span class=blur>92.255.85.35</span>)<SeP>IP03 (<span class=blur>185.7.214.180</span>)<SeP>IP12 (<span class=blur>218.92.0.230</span>)<SeP>IP13 (<span class=blur>218.92.0.216</span>)<SeP>IP14 (<span class=blur>218.92.0.220</span>)<SeP>IP16 (<span class=blur>218.92.0.233</span>)<SeP>IP15 (<span class=blur>218.92.0.227</span>)<SeP>IP17 (<span class=blur>218.92.0.114</span>)<SeP>IP18 (<span class=blur>218.92.0.229</span>)<SeP>IP19 (<span class=blur>218.92.0.217</span>)";
  ...
  const column4Data  = "651<SeP>612<SeP>371<SeP>360<SeP>350<SeP>349<SeP>349<SeP>345<SeP>343<SeP>342";
  const listLocale   = "en-US";
...
function listAttacksIPsEnglish()
{
  ...
  const column3Label = "Country";
  const column4Label = "Count";
  const column1Data  = "IP01 (<span class=blur>110.39.172.238</span>)<SeP>IP02 (<span class=blur>45.82.121.247</span>)<SeP>IP04 (<span class=blur>46.8.237.53</span>)<SeP>IP05 (<span class=blur>80.94.95.112</span>)<SeP>IP06 (<span class=blur>37.44.238.88</span>)<SeP>IP03 (<span class=blur>185.7.214.180</span>)<SeP>IP08 (<span class=blur>38.12.5.41</span>)<SeP>IP09 (<span class=blur>2.57.122.193</span>)<SeP>IP10 (<span class=blur>64.23.130.251</span>)<SeP>IP11 (<span class=blur>95.182.115.45</span>)";
  const column2Data  = "AS38264<SeP>AS44486<SeP>AS56971<SeP>AS204428<SeP>AS34534<SeP>AS207566<SeP>AS400619<SeP>AS47890<SeP>AS14061<SeP>AS56971";
  const column3Data  = "<span class=\u0022fi fi-pk\u0022></span>\u00a0Pakistan<SeP><span class=\u0022fi fi-de\u0022></span>\u00a0Germany<SeP><span class=\u0022fi fi-fi\u0022></span>\u00a0Finland<SeP><span class=\u0022fi fi-ro\u0022></span>\u00a0Romania<SeP><span class=\u0022fi fi-fr\u0022></span>\u00a0France<SeP><span class=\u0022fi fi-ru\u0022></span>\u00a0Russia<SeP><span class=\u0022fi fi-us\u0022></span>\u00a0United States<SeP><span class=\u0022fi fi-ro\u0022></span>\u00a0Romania<SeP><span class=\u0022fi fi-us\u0022></span>\u00a0United States<SeP><span class=\u0022fi fi-ru\u0022></span>\u00a0Russia";
  const column4Data  = "21293<SeP>6225<SeP>867<SeP>863<SeP>749<SeP>612<SeP>602<SeP>568<SeP>527<SeP>430";
  const listLocale   = "en-US";
...
function listCredentialsEnglish()
{
  ...
  const column12Data  = "345gs5662d34 345gs5662d34<SeP>root 3245gs5662d34<SeP>root admin<SeP>admin 3245gs5662d34<SeP>root  <SeP>root vizxv<SeP>odoo15 odoo15<SeP>root realtek<SeP>admin hp.com<SeP>root epon";
  const column3Data   = "5239<SeP>4623<SeP>1161<SeP>578<SeP>278<SeP>263<SeP>221<SeP>219<SeP>219<SeP>216";
  const listLocale    = "en-US";
  let   column1Data   = "";
  let   column2Data   = "";
  let   oneCredential = [];
...
function listMalwareEnglish()
{
  ...
  const column1Data  = "a8460f446be540410004b1a8db4083773fa46f7fe76fa84219c93daa1669f8f2<SeP>80c15d8108ea5828bdbdf8a5eff145358ca69532c748ca8ef44b1b82d962762d<SeP>01ba4719c80b6fe911b091a7c05124b64eeece964e09c058ef8f9805daca546b<SeP>d46555af1173d22f07c37ef9c1e0e74fd68db022f2b6fb3ab5388d2c5bc6a98e<SeP>3b15778595cef00d1a51035dd4fd65e6be97e73544cb1899f40aec4aaa0445ae<SeP>ea40ecec0b30982fbb1662e67f97f0e9d6f43d2d587f2f588525fae683abea73<SeP>d9fde4e5cc24e7a961520adfe1484237007292f9e53676dfa1c84e4acfc06742<SeP>94f2e4d8d4436874785cd14e6e6d403507b8750852f7f2040352069a75da4c00<SeP>8a68d1c08ea31250063f70b1ccb5051db1f7ab6e17d46e9dd3cc292b9849878b<SeP>f1beff22a446ad4acaec395fa58acb9373beaaa5914e12361b8832a3829b9b36";
  const column2Data  = "5440<SeP>761<SeP>176<SeP>22<SeP>22<SeP>13<SeP>13<SeP>13<SeP>12<SeP>11";
  let   column3Data  = "redir<SeP>redir<SeP>redir<SeP>upload<SeP>upload<SeP>upload<SeP>redir<SeP>upload<SeP>redir<SeP>download";
  const column4Data  = "malicious<SeP>NA<SeP>malicious<SeP>NA<SeP>NA<SeP>malicious<SeP>NA<SeP>NA<SeP>NA<SeP>malicious";
  const listLocale   = "en-US";
...
function listMalwareURLsEnglish()
{
  ...
  const column2Label = "Count";
  const column1Data  = "http://37.44.238.88<SeP>http://194.85.251.8<SeP>http://66.63.187.69<SeP>http://193.143.1.7<SeP>http://83.23.27.238<SeP>http://193.143.1.42<SeP>tftp://199.195.248.181<SeP>http://91.224.92.19<SeP>http://83.23.65.68<SeP>http://61.7.209.115";
  const column2Data  = "93<SeP>15<SeP>9<SeP>9<SeP>2<SeP>2<SeP>1<SeP>1<SeP>1<SeP>1";
  const listLocale   = "en-US";
...
function listProtocolsEnglish()
{
  ...
  const column2Data  = "120487<SeP>34843";
  const listLocale   = "en-US";
...
function listMalwareSpanish()
{
  ...
  const column2Data  = "5440<SeP>761<SeP>176<SeP>22<SeP>22<SeP>13<SeP>13<SeP>13<SeP>12<SeP>11";
  let   column3Data  = "redir<SeP>redir<SeP>redir<SeP>upload<SeP>upload<SeP>upload<SeP>redir<SeP>upload<SeP>redir<SeP>download";
  let   column4Data  = "malicious<SeP>NA<SeP>malicious<SeP>NA<SeP>NA<SeP>malicious<SeP>NA<SeP>NA<SeP>NA<SeP>malicious";
  const listLocale   = "it-IT";
...
function loadMapEnglish() {
  ...
  map.on("load", () => {
    ...
    map.addLayer({
      "id": "all-traffic",
      "metadata": {
        "name": "traffic between 2025-01-31 and 2025-03-01"
      },
      "type": "circle",
      "source": "all-traffic",
      "layout": {
    ...
    map.addLayer({
      "id": "all-scans",
      "metadata": {
        "name": "scans between 2025-01-31 and 2025-03-01"
      },
      "type": "circle",
      "source": "all-scans",
      "layout": {
    ...
    map.addLayer({
      "id": "all-attacks",
      "metadata": {
        "name": "attacks between 2025-01-31 and 2025-03-01"
      },
      "type": "circle",
      "source": "all-attacks",
      "layout": {
...
function loadMapSpanish() {
  ...
  map.on("load", () => {
    ...
    map.addLayer({
      "id": "all-traffic",
      "metadata": {
        "name": "tráfico entre 2025-01-31 y 2025-03-01"
      },
      "type": "circle",
      "source": "all-traffic",
      "layout": {
    ...
    map.addLayer({
      "id": "all-scans",
      "metadata": {
        "name": "escaneos entre 2025-01-31 y 2025-03-01"
      },
      "type": "circle",
      "source": "all-scans",
      "layout": {
    ...
    map.addLayer({
      "id": "all-attacks",
      "metadata": {
        "name": "ataques entre 2025-01-31 y 2025-03-01"
      },
      "type": "circle",
      "source": "all-attacks",
      "layout": {
...
function scansTrendEnglish()
{
  ...
  const itemData        = "66<SeP>79<SeP>51<SeP>50<SeP>36<SeP>62<SeP>109<SeP>92<SeP>107<SeP>76<SeP>81<SeP>100<SeP>64<SeP>95<SeP>62<SeP>61<SeP>43<SeP>13<SeP>33<SeP>118<SeP>70<SeP>98<SeP>174<SeP>64<SeP>51<SeP>52<SeP>73<SeP>64<SeP>23<SeP>49<SeP>43<SeP>123<SeP>123<SeP>77<SeP>100<SeP>78<SeP>88<SeP>62<SeP>43<SeP>89<SeP>90<SeP>25<SeP>79<SeP>157<SeP>134<SeP>114<SeP>78<SeP>94<SeP>94<SeP>46<SeP>61<SeP>83<SeP>57<SeP>105<SeP>90<SeP>51<SeP>52<SeP>112<SeP>86<SeP>160<SeP>112<SeP>63<SeP>74<SeP>124<SeP>41<SeP>102<SeP>69<SeP>29<SeP>25<SeP>41<SeP>29<SeP>75<SeP>84<SeP>139<SeP>105<SeP>252<SeP>56<SeP>96<SeP>91<SeP>80<SeP>66<SeP>44<SeP>61<SeP>0<SeP>0<SeP>0<SeP>0<SeP>76<SeP>111<SeP>36<SeP>17<SeP>51<SeP>24<SeP>56<SeP>79<SeP>95<SeP>78<SeP>76<SeP>45<SeP>87<SeP>103<SeP>33<SeP>17<SeP>41<SeP>26<SeP>90<SeP>74<SeP>55<SeP>40<SeP>42<SeP>33<SeP>75<SeP>59<SeP>109<SeP>70<SeP>35<SeP>70<SeP>38<SeP>63<SeP>66<SeP>84<SeP>151<SeP>205<SeP>105<SeP>104<SeP>127<SeP>80<SeP>82<SeP>95<SeP>132<SeP>195<SeP>45<SeP>118<SeP>47<SeP>100<SeP>83<SeP>76<SeP>78<SeP>117<SeP>62<SeP>75<SeP>78<SeP>86<SeP>61<SeP>74<SeP>160<SeP>51<SeP>46<SeP>102<SeP>94<SeP>180<SeP>119<SeP>69<SeP>123<SeP>102<SeP>130<SeP>81<SeP>176<SeP>52<SeP>86<SeP>65<SeP>90<SeP>52<SeP>117<SeP>80<SeP>61<SeP>60<SeP>84<SeP>57<SeP>79<SeP>93<SeP>163<SeP>73<SeP>147<SeP>81<SeP>127<SeP>48<SeP>65<SeP>74<SeP>113<SeP>135<SeP>130<SeP>25<SeP>72<SeP>123<SeP>51<SeP>75<SeP>80<SeP>83<SeP>110<SeP>146<SeP>157<SeP>117<SeP>49
>607<SeP>324<SeP>365<SeP>648<SeP>625<SeP>641<SeP>389<SeP>259<SeP>89<SeP>291<SeP>129<SeP>199<SeP>215<SeP>426<SeP>58<SeP>221<SeP>242<SeP>65<SeP>96<SeP>200<SeP>285<SeP>211<SeP>271<SeP>102<SeP>447<SeP>146<SeP>76<SeP>272<SeP>100<SeP>411<SeP>299<SeP>216<SeP>135<SeP>213<SeP>39<SeP>137<SeP>163<SeP>85<SeP>20<SeP>290<SeP>158<SeP>42<SeP>241<SeP>48<SeP>91<SeP>61<SeP>80<SeP>98<SeP>324<SeP>144<SeP>335<SeP>49<SeP>274<SeP>467<SeP>184<SeP>156<SeP>133<SeP>155<SeP>302<SeP>52<SeP>37<SeP>74<SeP>115<SeP>207<SeP>185<SeP>125<SeP>257<SeP>153<SeP>201<SeP>294<SeP>128<SeP>314<SeP>60<SeP>60<SeP>46<SeP>48<SeP>140<SeP>24<SeP>23<SeP>86<SeP>58<SeP>65<SeP>88<SeP>40<SeP>194<SeP>108<SeP>106<SeP>46<SeP>211<SeP>81";
...
function trafficPieCountryEnglish()
{
  ...
  const labelsData   = "China<SeP>Pakistan<SeP>Taiwan<SeP>United States<SeP>Germany<SeP>India<SeP>South Korea<SeP>Russia<SeP>Indonesia<SeP>France";
  const itemLabel   = "Unwanted Traffic";
  const itemData    = "24697<SeP>21693<SeP>14935<SeP>14255<SeP>9230<SeP>6531<SeP>5562<SeP>5115<SeP>4925<SeP>4444";
...
function scansPieCountryEnglish()
{
  ...
  const itemLabel   = "Scans";
  const itemData    = "15951<SeP>2679<SeP>2378<SeP>2119<SeP>1374<SeP>1073<SeP>722<SeP>644<SeP>434<SeP>430";
  const itemColor   = "rgba(216,149,31,0.75)" + ARRAY_SEP + "rgba(248,99,204,0.75)" + ARRAY_SEP + "rgba(197,5,148,0.75)" + ARRAY_SEP + "rgba(71,93,12,0.75)" + ARRAY_SEP + "rgba(14,74,15,0.75)" + ARRAY_SEP + "rgba(238,70,27,0.75)" + ARRAY_SEP + "rgba(249,145,159,0.75)" + ARRAY_SEP + "rgba(150,178,30,0.75)" + ARRAY_SEP + "rgba(239,179,82,0.75)" + ARRAY_SEP + "rgba(154,96,17,0.75)";
...
function attacksPieCountryEnglish()
{
  ...
  const labelsData   = "Pakistan<SeP>Taiwan<SeP>United States<SeP>China<SeP>Germany<SeP>South Korea<SeP>Indonesia<SeP>France<SeP>India<SeP>Russia";
  const itemLabel   = "Attacks";
  const itemData    = "21437<SeP>13862<SeP>11576<SeP>8746<SeP>8586<SeP>4840<SeP>4821<SeP>4264<SeP>4153<SeP>3741";
  const itemColor   = "rgba(216,149,31,0.75)" + ARRAY_SEP + "rgba(248,99,204,0.75)" + ARRAY_SEP + "rgba(197,5,148,0.75)" + ARRAY_SEP + "rgba(71,93,12,0.75)" + ARRAY_SEP + "rgba(14,74,15,0.75)" + ARRAY_SEP + "rgba(238,70,27,0.75)" + ARRAY_SEP + "rgba(249,145,159,0.75)" + ARRAY_SEP + "rgba(150,178,30,0.75)" + ARRAY_SEP + "rgba(239,179,82,0.75)" + ARRAY_SEP + "rgba(154,96,17,0.75)";
...
function trafficPieASNEnglish()
{
  ...
  const itemLabel   = "Unwanted Traffic";
  const itemData    = "21324<SeP>13283<SeP>11063<SeP>9168<SeP>6226<SeP>4407<SeP>4028<SeP>3281<SeP>3240<SeP>2645";
  const itemColor   = "rgba(216,149,31,0.75)" + ARRAY_SEP + "rgba(248,99,204,0.75)" + ARRAY_SEP + "rgba(197,5,148,0.75)" + ARRAY_SEP + "rgba(71,93,12,0.75)" + ARRAY_SEP + "rgba(14,74,15,0.75)" + ARRAY_SEP + "rgba(238,70,27,0.75)" + ARRAY_SEP + "rgba(249,145,159,0.75)" + ARRAY_SEP + "rgba(150,178,30,0.75)" + ARRAY_SEP + "rgba(239,179,82,0.75)" + ARRAY_SEP + "rgba(154,96,17,0.75)";
...
function scansPieASNEnglish()
{
  ...
  const itemLabel   = "Scans";
  const itemData    = "8925<SeP>2725<SeP>1959<SeP>1265<SeP>951<SeP>751<SeP>624<SeP>602<SeP>576<SeP>406";
  const itemColor   = "rgba(216,149,31,0.75)" + ARRAY_SEP + "rgba(248,99,204,0.75)" + ARRAY_SEP + "rgba(197,5,148,0.75)" + ARRAY_SEP + "rgba(71,93,12,0.75)" + ARRAY_SEP + "rgba(14,74,15,0.75)" + ARRAY_SEP + "rgba(238,70,27,0.75)" + ARRAY_SEP + "rgba(249,145,159,0.75)" + ARRAY_SEP + "rgba(150,178,30,0.75)" + ARRAY_SEP + "rgba(239,179,82,0.75)" + ARRAY_SEP + "rgba(154,96,17,0.75)";
...
function attacksPieASNEnglish()
{
  ...
  const itemData    = "21323<SeP>12332<SeP>8592<SeP>6225<SeP>3884<SeP>3783<SeP>3274<SeP>2527<SeP>2403<SeP>2138";
  const itemColor   = "rgba(216,149,31,0.75)" + ARRAY_SEP + "rgba(248,99,204,0.75)" + ARRAY_SEP + "rgba(197,5,148,0.75)" + ARRAY_SEP + "rgba(71,93,12,0.75)" + ARRAY_SEP + "rgba(14,74,15,0.75)" + ARRAY_SEP + "rgba(238,70,27,0.75)" + ARRAY_SEP + "rgba(249,145,159,0.75)" + ARRAY_SEP + "rgba(150,178,30,0.75)" + ARRAY_SEP + "rgba(239,179,82,0.75)" + ARRAY_SEP + "rgba(154,96,17,0.75)";
